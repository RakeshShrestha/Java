...
<%@ include file="MasterTop.jsp" %>
    <h2><a href="Members.jsp"><font size="4">Members</font></a></h2>

    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
      <tr>
        <td width="29%"><font size="4">Products</font></td>
        <td width="71%" align="right"><form method=get action="ProductLine.jsp">
...
<input type="hidden" name="companycode" value="<%=StringEscapeUtils.escapeHtml(company.Code)%>">
...
<tr>
<% 			} %>
    <td align="center"><% if( product.ImageURL != null && product.ImageURL.length() > 0 ) { %><a href="<%= productURL%>"><img style="max-width: 120px; max-height: 120px;" border="0" src="<%=StringEscapeUtils.escapeHtml(product.ImageURL)%>"></a><br><% } %>
